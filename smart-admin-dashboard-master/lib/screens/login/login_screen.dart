          ...
          children: [
            ...
            AppButton(
              ...
              onPressed: () async{
                  ...
                  var result = await   provider.createEmailAndPasswordLogin(emailController.text, passwordController.text);
          ...
          children: [
            ...
            AppButton(
              ...
              onPressed: () async {
                  ...
                  var result = await   provider.emailAndPasswordLogin(emailController.text, passwordController.text);
                //    print(' the result is $result');          
                // if(result== true){
                //    Navigator.push(
                //   context,
